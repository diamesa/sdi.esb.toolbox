...
<head>
	...
	<title>Education Solution Builder SDI Tool box</title>

	<link rel="stylesheet" type="text/css" href="css/bootstrap.min.css">
	<link rel="stylesheet" type="text/css" href="css/sdi_toolbox.css">

</head>
<body>
<div class="container well crud-pannel" id="crearProducto">
						<div class="row">
							<div class="col-xs-12 well h2bg" id="form-title">
								<h2 class="myfcc-jumbo-h2">Business Account Validation</h2>
							</div>
						</div>
